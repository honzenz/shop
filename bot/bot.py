...
BASE_PRODUCTS = {
    # Папка Мt$
    "mts_gu_valid_pass": {"name": "MtS GU Valid PASS", "price": 4.5, "category": "logs"},
    "mts_ya": {"name": "MtS YA", "price": 0.5, "category": "logs"},
    "mts_wb": {"name": "MtS WB", "price": 0.5, "category": "logs"},
    
    # Папка T2 $мeнa
    "t2_mena_ya": {"name": "Smena YA", "price": 0.5, "category": "logs"},
    "t2_mena_wb": {"name": "Smena WB", "price": 0.5, "category": "logs"},
    "t2_mena_valid_pass_kazan": {"name": "Smena Valid PASS Kазань", "price": 3.5, "category": "logs"},
    "t2_mena_valid_pass_nizhny": {"name": "Smena Valid PASS Нижегoродская", "price": 3.5, "category": "logs"},
    "t2_mena_valid_pass_spb": {"name": "Smena Valid PA$$ СПБ", "price": 3.5, "category": "logs"},
    
    # Папка Meg@
    "mega_gu_valid_pass": {"name": "Mega GU Valid PA$$", "price": 3.5, "category": "logs"},
    "mega_ya": {"name": "Mega YA", "price": 0.5, "category": "logs"},
    "mega_wb": {"name": "Mega WB", "price": 0.5, "category": "logs"},
}
